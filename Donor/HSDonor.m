...
- (id) init
{
    ...
    if(self != nil)
    {
        ...
        if(user != nil)
        {
            ...
            mSex = [user integerForKey:@"Sex" asDefaults:HSDonorSexUnknown];
            mBloodGroup = [user integerForKey:@"BloodGroup" asDefaults:HSDonorBloodGroupUnknown];
            mBloodRh = [user integerForKey:@"BloodRh" asDefaults:HSDonorBloodRhUnknown];
