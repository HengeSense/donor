...
namespace DonorAppW8
{
    ...
    /// внутри группы.
    /// </summary>
    public sealed partial class NewsGroupDetailPage : DonorAppW8.Common.LayoutAwarePage
    {
        public NewsGroupDetailPage()
        {
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            var itemId = ((NewsViewModel)e.ClickedItem).UniqueId;
