...
namespace DonorAppW8
{
    ...
    /// внутри группы.
    /// </summary>
    public sealed partial class AdGroupDetailPage : DonorAppW8.Common.LayoutAwarePage
    {
        public AdGroupDetailPage()
        {
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            var itemId = ((AdsViewModel)e.ClickedItem).UniqueId;
            this.Frame.Navigate(typeof(AdDetailPage), itemId);
        }
    }
}
