...
namespace DonorAppW8
{
    ...
    /// </summary>
    public sealed partial class AdDetailPage : DonorAppW8.Common.LayoutAwarePage
    {
        public AdDetailPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var item = ViewModelLocator.MainStatic.Ads.Items.FirstOrDefault(c => c.UniqueId == (String)navigationParameter);
            this.DefaultViewModel["Group"] = ViewModelLocator.MainStatic.Groups.FirstOrDefault(c=>c.UniqueId=="Ads");
            this.DefaultViewModel["Items"] = ViewModelLocator.MainStatic.Groups.FirstOrDefault(c=>c.UniqueId=="Ads").Items;
        ...
        {
            var selectedItem = (AdsViewModel)this.flipView.SelectedItem;
