...
-(UIView *)renderViewInBounds: (CGRect)bounds {
    ...
    UIImage *resultImage = [self imageForBloodDonationType: bloodDonationEvent.bloodDonationType];
    if (resultImage == nil) {
...
-(UIImage *)imageForBloodDonationType: (HSBloodDonationType)bloodDonationType {
    switch (bloodDonationType) {
        case HSBloodDonationType_Blood:
            return [UIImage imageNamed: @"calendarScheduledBloodIcon.png"];
        case HSBloodDonationType_Plasma:
            return [UIImage imageNamed: @"calendarScheduledPlasmaIcon.png"];
        case HSBloodDonationType_Platelets:
            return [UIImage imageNamed: @"calendarScheduledPlateletsIcon.png"];
        case HSBloodDonationType_Granulocytes:
            return [UIImage imageNamed: @"calendarScheduledGranulocytesIcon.png"];
        default:
            @throw [NSException exceptionWithName: NSInternalInconsistencyException
